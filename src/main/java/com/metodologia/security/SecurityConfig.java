    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationManager authenticationManager) throws Exception {
        ...
        return httpSecurity
            ...
            .authorizeHttpRequests(auth -> {
                auth.requestMatchers("/solicitarTurno", "/usuarios","/profesionales","/user/**", "/createUser","/finalizados/**" ,"/listTurnPendiente","/listTurnCancelado","/listTurnEnProceso","/listTurnFinalizado","/listTurnPendientePago","/payment/**","/register", "/login", "/solicitarTurno", "/deleteUser/**", "/listarUser", "/user/**", "/crearServicio", "/deleteServicio/**", "/listaServicio", "/servicio/**", "/deleteTurn/**", "/listTurn", "/turn/**").permitAll();
